...
import { Lock, ArrowRight, Download, Loader2, CheckCircle, AlertCircle, FileText, Trash2, RefreshCw, KeyRound, Eye, EyeOff } from 'lucide-react';
...
export default function ProtectPage() {
    ...
    const handleProtect = async () => {
        ...
        try {
            const response = await api.protectPdf(file.id, password);
        ...
        <div className="min-h-screen py-12 bg-gradient-to-b from-rose-50 to-white">
            <div className="max-w-4xl mx-auto px-4">
                ...
                <div className="text-center mb-10">
                    <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-rose-500 to-rose-600 flex items-center justify-center mx-auto mb-6 shadow-lg shadow-rose-500/25">
                ...
                <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-slate-100">
                    <div className="p-8">
                        {state === 'idle' && !file && (
                            <div
                                {...getRootProps()}
                                className={`border-2 border-dashed rounded-2xl p-10 text-center cursor-pointer transition-colors ${isDragActive ? 'border-rose-500 bg-rose-50' : 'border-slate-200 hover:border-rose-500 hover:bg-slate-50'
                                    }`}
                            >
                                <input {...getInputProps()} />
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="max-w-md mx-auto">
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            className="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl focus:ring-2 focus:ring-rose-500 focus:border-rose-500 outline-none transition-all pr-12 text-slate-900 placeholder:text-slate-400"
                                        />
                                        <button
                                            type="button"
                                ...
                                <div className="flex justify-center">
                                    <button
                                        ...
                                        disabled={!password}
                                        className={`flex items-center gap-2 px-8 py-4 bg-rose-600 text-white rounded-xl font-semibold hover:bg-rose-700 transition-colors shadow-lg shadow-rose-500/25 ${!password ? 'opacity-50 cursor-not-allowed' : ''
                                            }`}
                                    >
                                        Protect PDF
                        ...
                        {state === 'processing' && (
                            <div className="text-center py-10">
                                ...
                                <h3 className="text-xl font-bold text-slate-900 mb-2">Protecting PDF...</h3>
                                <p className="text-slate-500 mb-6">Encrypting your document</p>
                        ...
                        {state === 'completed' && result && (
                            <div className="text-center py-8">
                                ...
                                <h3 className="text-2xl font-bold text-slate-900 mb-2">Protection Complete!</h3>
                                <p className="text-slate-500 mb-8">Your PDF is now password protected</p>

                                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                    <button
                                        onClick={handleDownload}
                                        className="flex items-center justify-center gap-2 px-8 py-4 bg-rose-600 text-white rounded-xl font-semibold hover:bg-rose-700 transition-colors shadow-lg shadow-rose-500/25"
                                    >
                        ...
                        {state === 'error' && (
                            <div className="text-center py-8">
                                ...
                                <h3 className="text-xl font-bold text-slate-900 mb-2">Protection Failed</h3>
                ...
                <div className="mt-8 text-center">
                    <Link href="/" className="text-slate-500 hover:text-rose-600 font-medium transition-colors">
                        ← Back to all tools
                    </Link>
                </div>
            </div>
